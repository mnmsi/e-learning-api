                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" id="acc_type_id"
                                        ...
                                        @foreach($accTypes as $acType)
                                            <option
                                                value="{{$acType->id}}"
                                                {{old('acc_type_id', $acc_type_id) == $acType->id ? 'selected' : ''}}>
                                                {{$acType->name}}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" name="age_type_id" required>
                                        ...
                                        @foreach($ageTypes as $aType)
                                            ...
                                            <option
                                                value="{{$aType->id}}"
                                                {{old('age_type_id', $age_type_id) == $aType->id ? 'selected' : ''}}>
                                                {{$aType->name}}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" name="ethnicity_id" required>
                                        ...
                                        @foreach($ethnicity as $eth)
                                            <option
                                                value="{{$eth->id}}"
                                                {{old('ethnicity_id', $ethnicity_id) == $eth->id ? 'selected' : ''}}>
                                                {{$eth->name}}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6 col-sm-12">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="phone" class="form-control"
                                           placeholder="Phone Number" value="{{ old('phone', $phone) }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="birth_date" class="form-control"
                                           value="{{ old('birth_date', $birth_date) }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" class="dropify form-control"
                                           accept="image/*" id="avatar" data-default-file="{{ $avatar }}"
                                           name="avatar"/>
