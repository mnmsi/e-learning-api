        ...
        <div class="col-12">
            <div class="card mb-4 p-md-5 p-4">
                <div class="card-body px-0 pt-0 pb-2">
                    <form role="form" method="POST" action="{{ route('category.update', $id) }}"
                            ...
                            <div class="col-md-5 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="file" class="dropify form-control"
                                           accept="image/*" value="{{ old('image', $image) }}" id="image"
                                           name="image" data-default-file="{{ $image }}"/>
